      ...
      <form onSubmit={handleSubmit}>
        ...
        {selectedProductCode && (
          <p className="subtitle" style={{ marginBottom: '0.75rem' }}>
            Showing {PRODUCT_CODE_TO_LABEL[selectedProductCode] ?? selectedProductCode} for this policy stream. Other product terms are preserved unchanged.
          </p>
        )}
